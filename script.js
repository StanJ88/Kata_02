...
if (coordinates.length === 0) {
    ...
    city.innerText = coordinates[0].name
...
const response = await fetch (`https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&hourly=temperature_2m&current=temperature_2m,relative_humidity_2m`)
...
console.log(weather.current.relative_humidity_2m)
